...
<div class="container bg-white" style="padding: 10px; border-radius: 10px;">
    ...
    <table class="table table-striped ">
        ...
        <tbody>
        <c:forEach var="ct" items="${sizes.content}" varStatus="i">
            <tr>
                ...
                <td>
                    <a href="/shop-app/sizes/view-update?id=${ct.id}&page=${currentPage}&size=${currentSize}"
                       class="btn btn-warning">Edit</a>
                    <a href="/shop-app/sizes/detail?id=${ct.id}&page=${currentPage}&size=${currentSize}"
                       class="btn btn-info">Info</a>
                    <a href="/shop-app/sizes/update-status?id=${ct.id}"
