...
<div class="container bg-white" style="padding: 10px; border-radius: 10px;">
    ...
    <table class="table table-striped ">
        ...
        <tbody>
        <c:forEach var="st" items="${colors.content}" varStatus="i">
            <tr>
                ...
                <td>
                    <a href="/shop-app/colors/view-update?id=${st.id}&page=${currentPage}&size=${currentSize}"
                       class="btn btn-warning">Edit</a>
                    <a href="/shop-app/colors/detail?id=${st.id}&page=${currentPage}&size=${currentSize}"
                       class="btn btn-info">Info</a>
                    <a href="/shop-app/colors/update-status?id=${st.id}"
